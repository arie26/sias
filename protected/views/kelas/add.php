				...
				<div class="widget-main">
					<div class='step-content row-fluid position-relative' id='step-container'>
						<div class='step-pane active' id='step1'>
							<form class='form-horizontal' enctype="multipart/form-data" id="addkelas" method="POST" action="<?php echo Yii::app()->getBaseUrl(true).'/kelas/add'; ?>" >
								<div class='form-group'>
									...
									<div class='col-xs-12 col-sm-9'>
										<div class='clearfix'>
											<div class='clearfix'>
											<input class='col-xs-12 col-sm-6' type='text' name='Kelass[nama]' id='kelas_nama' required/>
										</div>
										</div>
									</div>
								</div>
								...
								<div class='form-group'>
									...
									<div class='col-xs-12 col-sm-9'>
										<div class='clearfix'>
											<input class='col-xs-12 col-sm-6' type='text' name='Kelass[kapasitas]' id='kelas_kapasistas' required/>
										</div>
									</div>
								</div>
								...
								<div class='form-group'>
									...
									<div class="col-xs-12 col-sm-6">
										<div class="control-group">
											...
											<div class="radio">
												<label>
													<input  type="radio" value="1" name="Kelass[status]" id="kelas_status" class="ace" checked="checked" required/>
