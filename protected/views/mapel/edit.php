				...
				<div class="widget-main">
					<div class='step-content row-fluid position-relative' id='step-container'>
						<div class='step-pane active' id='step1'>
							<form class='form-horizontal' enctype="multipart/form-data" id="addmapel" method="POST" action="<?php echo Yii::app()->getBaseUrl(true).'/mapel/edit/'.Yii::app()->getSecurityManager()->encrypt($mapels->id_mapel);?>" >
								<div class='form-group'>
									<label class='control-label col-xs-12 col-sm-2 no-padding-right' for='mapel_nama'>Nama<font color="red">*</font> :</label>

									<div class='col-xs-12 col-sm-9'>
										<div class='clearfix'>
											<input class='col-xs-12 col-sm-6' type='text' name='Mapels[nama]' id='mapel_nama' value="<?php echo $mapels->nama?>" required/>
										</div>
									</div>
								</div>
								...
								<div class='form-group'>
									...
									<div class="col-xs-12 col-sm-6">
										<div class="control-group">
											...
											<div class="radio">
												<label>
													<input  type="radio" value="1" name="Mapels[sifat]" id="mapel_status" class="ace" checked="checked" 
													<?php if($mapels->sifat == 1){echo "checked=checked";} ?> />
											...
											<div class="radio">
												<label>
													...
													<?php if($mapels->sifat == 2){echo "checked=checked";} ?>/>
								...
								<div class='form-group'>
									...
									<div class="col-xs-12 col-sm-6">
										<div class="control-group">
											...
											<div class="radio">
												<label>
													<input  type="radio" value="1" name="Mapels[status]" id="mapel_status" class="ace" checked="checked"
													<?php if($mapels->status == 1){echo "checked=checked";} ?>/>
											...
											<div class="radio">
												<label>
													...
													<?php if($mapels->status == 2){echo "checked=checked";} ?>/>
