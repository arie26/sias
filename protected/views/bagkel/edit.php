	...
	<div class="col-xs-12">
		<div class="widget-box">
			<div class="widget-header" >
				<h5>Edit Data Pembagian Kelas</h5>
				...
				<div class="widget-main">
					<div class='step-content row-fluid position-relative' id='step-container'>
						<div class='step-pane active' id='step1'>
							<form class='form-horizontal' enctype="multipart/form-data" id="addkelas" method="POST" action="<?php echo Yii::app()->getBaseUrl(true).'/bagkel/edit/'.Yii::app()->getSecurityManager()->encrypt($bagkel->id_pembagian_kelas); ?>" >
								<div class='form-group'>
									...
									<div class='col-xs-12 col-sm-9'>
										<div class='clearfix'>
											<input class='col-xs-12 col-sm-6' type='text' name="Bagkels[id_tahann]" id='kelas_nama' value="<?php echo $bagkel->idTahunAjaran->nama; ?>" disabled="true">
											<input class='col-xs-12 col-sm-6' type='hidden' name="Bagkels[id_tahun_ajaran]" id='kelas_nama_hidden' value="<?php echo $bagkel->idTahunAjaran->id_tahun_ajaran; ?>" >
										</div>
									</div>
								</div>
								...
								<div class='form-group'>
									...
									<div class='col-xs-12 col-sm-3'>
										<select name="Bagkels[id_kelas]" id="Kelass_wali_kelas" class="form-control">
												<option value="<?php echo $bagkel->id_kelas; ?>"><?php echo $bagkel->idKelas->nama; ?></option>
								...
								<div class='form-group'>
									...
									<div class='col-xs-12 col-sm-3'>
										<select name="Bagkels[id_siswa]" id="Kelass_wali_kelas" class="form-control">
												<option value="<?php echo $bagkel->id_siswa; ?>"><?php echo $bagkel->idSiswa->nama; ?></option>q
