				...
				<div class="widget-main">
					<div class='step-content row-fluid position-relative' id='step-container'>
						<div class='step-pane active' id='step1'>
							<form class='form-horizontal' enctype="multipart/form-data" id="addkelas" method="POST" action="<?php echo Yii::app()->getBaseUrl(true).'/jadwal/add'; ?>" >
								<div class='form-group'>
									...
									<div class='col-xs-12 col-sm-9'>
										<div class='clearfix'>
											<input class='col-xs-12 col-sm-6' type='text' name="Jadwals[id_tahann]" id='kelas_nama' value="<?php echo $tahan->nama; ?>" disabled="true">
											<input class='col-xs-12 col-sm-6' type='hidden' name="Jadwals[id_tahun_ajaran]" id='kelas_nama_hidden' value="<?php echo $tahan->id_tahun_ajaran; ?>" >
										</div>
									</div>
								</div>
