...
<!-- Mirrored from 192.69.216.111/themes/preview/ace/login.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 15 Nov 2013 07:14:00 GMT -->
<head>
		<meta charset="utf-8" />
		<title>SIAS</title>
		...
		<link rel="shortcut icon" href="<?php echo Yii::app()->request->baseUrl; ?>/media/images/favicon.ico" type="image/x-icon">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span><img width="90px" height="90px" src="<?php echo Yii::app()->request->baseUrl; ?>/media/images/lambang.png" alt="Jason's Photo"/></span>
									<!--<span class="red">SIAS</span>-->
									<span class="white"></span>
								</h1>
								<!--<h4 class="blue">&copy; SMA Muhammadiyah 3 Jakarta</h4>-->
								<h4 class="blue">Sistem Informasi Akademik Sekolah</h4>
							</div>
